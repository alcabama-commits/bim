...
export class DXFParser {
    ...
    parse(dxfContent: string): DXFDrawing {
    ...
    private addEntityProperty(entity: any, code: string, value: string): void {
    ...
    private processEntity(entity: any): DXFEntity {
        // Convertir coordenadas y normalizar
        if (entity.x1 !== undefined) entity.x1 = parseFloat(entity.x1);
        if (entity.y1 !== undefined) entity.y1 = parseFloat(entity.y1);
        if (entity.x2 !== undefined) entity.x2 = parseFloat(entity.x2);
        if (entity.y2 !== undefined) entity.y2 = parseFloat(entity.y2);
        if (entity.radius !== undefined) entity.radius = parseFloat(entity.radius);
        if (entity.startAngle !== undefined) entity.startAngle = parseFloat(entity.startAngle);
        if (entity.endAngle !== undefined) entity.endAngle = parseFloat(entity.endAngle);

        return entity;
    }

    private calculateBounds(drawing: DXFDrawing): void {
